%% Artificial Inteligence and Autonomous Systems
% Assignment 1
% > Miguel Elizalde
% > Oscar Peña
...
fprintf('Bread first Aglorithm Path')
pathBF = reconstruct_path(exploredBF, start, goal);
fprintf('\n')

fprintf('A-Star Aglorithm Path')
pathA = reconstruct_path(exploredA, start, goal);
fprintf('\n')
%disp('path');
%disp(path)
